function [Theta1, Theta2, minicost] = nnGaussianLogistic(X, y, ...
...
initial_Theta2 = randInitGrad(hidden_layer_size+1, num_labels);
initial_nn_params = [initial_Theta1(:) ; initial_Theta2(:)];

%  Train the model.
options = optimset('MaxIter', maxIter);
costFunction = @(p) nnCostFuncGaussianLogistic(p, ...
                                   input_layer_size, ...
                                   hidden_layer_size, ...
